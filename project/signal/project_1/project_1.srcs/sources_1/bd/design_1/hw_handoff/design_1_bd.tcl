...
proc create_root_design { parentCell } {
  ...
  set ctrl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 ctrl ]
  ...
  # Create instance: bpnn_0, and set properties
  set bpnn_0 [ create_bd_cell -type ip -vlnv left_bpnn:hls:bpnn:1.0 bpnn_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports ctrl] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins vga640x480_v1_1_0/s00_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins bpnn_0/s_axi_CTRLS] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net UART0_RX_0_1 [get_bd_ports UART0_RX] [get_bd_pins processing_system7_0/UART0_RX]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins bpnn_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins vga640x480_v1_1_0/s00_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bpnn_0/s_axi_CTRLS/Reg] SEG_bpnn_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vga640x480_v1_1_0/s00_axi/reg0] SEG_vga640x480_v1_1_0_reg0
